...
class _LoggedInPageState extends State<LoggedInPage>
  ...
  void _addUser() {
    Navigator.of(context)
        ...
        .then((value) => Provider.of<FirebaseProvider>(context, listen: false)
            .getTaskFromFirebase());
  }
                                      ...
                                      children: [
                                        Consumer<FirebaseProvider>(
                                            builder: (context, obj, child) {
                                              return Text('${obj.getTotalTasks}',style: const TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 28),);
                                            }),
                                        const Text(
                                ...
                                : SizedBox(
                                    ...
                                    child: ListView.separated(
                                      ...
                                      itemBuilder: (BuildContext context,
                                        ...
                                        if (index == 0) {
                                          return const Padding(
                                            padding: EdgeInsets.only(left: 28.0,top: 18,bottom: 18),
                                            child: Text('INBOX',style: TextStyle(fontSize: 20),),
                                          );
                                        } else {
                                          return Padding(
                                            ...
                                            child: ListTile(
                                              leading: Container(
                                                  ...
                                                  child: Center(child: index %2 == 0?FaIcon(FontAwesomeIcons.brush,color: Colors.blue.shade300,):FaIcon(FontAwesomeIcons.paintbrush,color: Colors.blue.shade300,))),
                                              trailing: Text(
